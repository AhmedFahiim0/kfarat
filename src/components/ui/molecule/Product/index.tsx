...
import SentenceAnimation from "./TextAnimation";
...
const Product: React.FC<ProductProps> = ({ data, type }) => {
  ...
  return (
    <>
      {type === "grid" ? (
        <div className="product-item grid-type relative">
          <div
            onClick={() => handleDetailProduct(data.id)}
            className="product-main cursor-pointer block"
          >
            <div className="product-thumb bg-[#f1f1f1] relative overflow-hidden rounded-2xl border border-line">
              {data.new && (
                  ...
                  <>
                    {
                      <Image
                        ...
                        alt={data.name}
                        priority={true}
                        className="w-full h-full object-fill duration-700"
                      />
                    }
                  </>
                ) : (
              ...
              {data.sale && (
                <>
                  <Marquee className="banner-sale-auto bg-maincolor absolute bottom-0 left-0 w-full py-1.5">
                    <div
              ...
              <div className="list-action grid grid-cols-2 gap-3 px-5 absolute w-full bottom-5 max-lg:hidden">
                <div
                  className="quick-view-btn w-full text-button-uppercase py-2 text-center rounded-full duration-300 bg-[#effafe] hover:bg-maincolor hover:text-white"
                  onClick={(e) => {
                    e.stopPropagation();
                    handleQuickviewOpen();
                  }}
                ...
                {data.action === "add to cart" ? (
                  <div
                    className="add-cart-btn w-full text-button-uppercase py-2 text-center rounded-full duration-500 bg-[#effafe] hover:bg-maincolor hover:text-white"
                    onClick={(e) => {
                      e.stopPropagation();
                      handleAddToCart();
                    }}
                  ...
                  <>
                    <div
                      className="quick-shop-btn text-button-uppercase py-2 text-center rounded-full duration-500 bg-[#effafe] hover:bg-maincolor hover:text-white"
                      onClick={(e) => {
                        e.stopPropagation();
            ...
            <div className="product-infor mt-4 lg:mb-7">
              ...
              <SentenceAnimation />
              <div className="product-name text-title duration-300 sm:flex gap-1 hidden ">
                <div>Poland </div> / <div>2024 </div>
              </div>
              <div className="list-color ">
                <div className="product-origin-price caption1 text-secondary2 mb-1">
                  {data.price / 4} SAR / month - 4 payments
                </div>
                <div className=" flex justify-start  gap-3">
                  <Image
                    src={"/images/product_info/tabby.png"}
                    width={500}
                    height={500}
                    className="w-14"
                    alt="dddd"
                  />
                  <Image
                    src={"/images/product_info/tamara.png"}
                    width={500}
                    height={500}
                    className="w-14"
                    alt="dddd"
                  />
                  <Image
                    src={"/images/product_info/mispay.png"}
                    width={500}
                    height={500}
                    className="w-14 "
                    alt="dddd"
              ...
              <div className="product-price-block flex items-center gap-2 flex-wrap mt-1 duration-300 relative z-[1] ">
                ...
                {percentSale > 0 && (
                  <>
                    ...
                    <div className="product-sale caption1 font-medium bg-[#e1ffe9] px-3 py-0.5 inline-block rounded-full text-success">
                      -{percentSale}%
                    </div>
                  </>
                )}
          ...
          <Image
            ...
            height={100}
            alt="blo"
            className="w-24 sm:w-32 absolute top-[10px] right-2 sm:right-5  bg-white rounded-xl"
          />
        </div>
      ) : (
        <>
          ...
          <div className="bg-img relative w-full">
            ...
            <div className="list-action flex flex-col gap-1 absolute top-0 right-0">
              <span
                className={`${
                  type === "road" ? "hidden" : ""
                } add-wishlist-btn w-8 h-8 bg-white flex items-center justify-center rounded-full box-shadow-sm duration-300 ${
                  wishlistState.wishlistArray.some(
                    (item) => item.id === data.id
                  )
                    ? "active"
              ...
              <span
                className={`${
                  type === "road" ? "hidden" : ""
                } compare-btn w-8 h-8 bg-white flex items-center justify-center rounded-full box-shadow-sm duration-300 ${
              ...
              <span
                className={`${
                  type === "road" ? "w-10 h-10" : "w-8 h-8"
                } quick-view-btn  bg-white hover:bg-maincolor flex items-center justify-center rounded-full box-shadow-sm duration-300`}
                onClick={(e) => {
                  e.stopPropagation();
                  handleQuickviewOpen();
                }}
              >
                {" "}
                {type === "road" ? <Icon.ShoppingBagOpen /> : <Icon.Eye />}
              </span>
              <span
                className={`${
                  type === "road" ? "hidden" : ""
                } add-cart-btn w-8 h-8 bg-white flex items-center justify-center rounded-full box-shadow-sm duration-300`}
                onClick={(e) => {
                  e.stopPropagation();
                  handleAddToCart();
                }}
